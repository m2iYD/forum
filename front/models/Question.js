export class Question {
  constructor(id_question, content, user_id, theme_id, created_at, updated_at, answers = []) {
  ...
  static async findAll() {
    try {
      ...
      return questions.map(q => new Question(q.id_question, q.content, q.user_id, q.theme_id, q.created_at, q.updated_at, q.answers || []));
    } catch (error) {
  ...
  static async findById(id) {
    try {
      ...
      return new Question(q.id_question, q.content, q.user_id, q.theme_id, q.created_at, q.updated_at, q.answers || []);
    } catch (error) {
  ...
  static async getAnswers(id) {
    try {
      const response = await fetch(`http://localhost:8001/questions/${id}/answers`);
  ...
  static async fakeFindAll() {
    return [
      new Question(1, "What is JavaScript?", 101, 1, "2025-03-06", "2025-03-06", ["Answer 1", "Answer 2"]),
      new Question(2, "Best way to learn CSS?", 102, 2, "2025-03-05", "2025-03-05", ["Answer 3"]),
      new Question(3, "How does the event loop work?", 103, 1, "2025-03-04", "2025-03-04", []),
    ];
  }
